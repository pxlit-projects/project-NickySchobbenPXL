...
@Component({
  selector: 'app-post-published-item-small',
  standalone: true,
  imports: [
    RouterLink
  ],
  templateUrl: './post-published-item-small.component.html',
  styleUrl: './post-published-item-small.component.css'
})
export class PostPublishedItemSmallComponent implements OnInit{
  @Input() post!: Post;
  backgroundPicture = '';
  imageUrls = [
